...
namespace SteamCalc
{
    public partial class Form1 : MetroForm
    {
        ...
        {
            if (String.IsNullOrEmpty(metroTextBox1.Text)) return;
            double a = 0;
        ...
        {
            if (String.IsNullOrEmpty(metroTextBox2.Text) || String.IsNullOrEmpty(metroTextBox3.Text)) return;
            double a, b;
        ...
        {
            if (String.IsNullOrEmpty(metroTextBox6.Text)) return;
            double a;
        ...
        {
            if (String.IsNullOrEmpty(metroTextBox7.Text) || String.IsNullOrEmpty(metroTextBox9.Text) || String.IsNullOrEmpty(metroTextBox5.Text)) return;
            double a, b, c;
